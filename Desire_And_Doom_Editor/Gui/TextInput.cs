...
namespace Desire_And_Doom_Editor.cs.Gui
{
    class TextInput : Panel
    {
        ...
        public TextInput(Monogui gui, bool scale = false) : base(gui, scale)
        {
            Width = 64;
            Height = 24;
        }
        ...
        public override void Key_Typed(char charactor)
        {
            ...
            var acceptable = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ" +
                             "{}[]()<>,.?/'\";:~`!@#$%^&*()_+\\|1234567890-= ";
            
            if (font.MeasureString(Text).X < Width - 16 && acceptable.Contains(charactor))
                Text += charactor;
        }
