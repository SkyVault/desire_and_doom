return {
	generate = {
		...
		["player-claymore-attack-1"]	= {128, 0, 64, 36, 6,	right_offset_x = 7, right_offset_y = 10, left_offset_x = -3, left_offset_y = 10, speed = 0.08},
		["player-claymore-attack-2"]	= {128 + 64 * 6, 0, 72, 36, 6,	right_offset_x = 7, right_offset_y = 10, left_offset_x = -3, left_offset_y = 10, speed = 0.08},
		--
